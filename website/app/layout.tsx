...
export const metadata = {
  ...
  description:
    'Master the Canadian Computing Competition with 270+ detailed solutions in C++, Python & Java. Complete CCC solutions from 1996-2026 with test cases, multiple approaches & explanations. Prepare for University of Waterloo CCC.',
  keywords:
    'CCC, Canadian Computing Competition, CCC solutions, CCC 2026, CCC 2025, CCC 2024, University of Waterloo, Waterloo CCC, CEMC, competitive programming, CCC preparation, CCC past problems, CCC contest, CCC test cases, programming contest Canada, algorithm practice, coding competition, CCC Senior, CCC Junior, s1 s2 s3 s4 s5, j1 j2 j3 j4 j5, graph theory, dynamic programming, data structures',
  ...
  openGraph: {
    ...
    description:
      'Master the Canadian Computing Competition with 270+ detailed solutions in C++, Python & Java. Complete CCC solutions from 1996-2026 with test cases and explanations.',
  ...
  twitter: {
    ...
    title: 'CCCSolutions 2026 | Canadian Computing Competition Solutions',
    description:
      'Master the Canadian Computing Competition with 270+ detailed solutions in C++, Python & Java from 1996-2026.',
  },
  other: {
    'theme-color': '#1e3a8a',
  },
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              description:
                'The most comprehensive Canadian Computing Competition solution repository with 270+ solutions from 1996 to 2026',
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              url: 'https://cccsolutions.ca',
              description:
                'Complete Canadian Computing Competition solution repository from 1996-2026',
              potentialAction: {
                '@type': 'SearchAction',
                target: {
                  '@type': 'EntryPoint',
